        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card mx-auto mt-5 text-bg-dark bg-opacity-75">
                    <div class="card-body">
                        <h1 class="text-danger text-center mb-3">Kontaktai</h1>
                        <div class="mb-5 text-center">
                            <p>Rekvizitai:<BR>
                                ...
                                Kęstučio g. 60A<BR>
                                LT-011111 Vilnius<BR>
                                El. paštas: info@bit.lt<BR>

                                Įmonės kodas: 31311313131<BR>
                                PVM Mokėtojo kodas: LT10010101010010<BR>
                            </p>
                        </div>
