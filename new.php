...
if (isset($_POST['action']) && $_POST['action'] == 'insert') {
    try {
        $sql = "INSERT INTO notes (type, note, time) VALUES (?, ?, ?)";
        $stm = $pdo->prepare($sql);
        $stm->execute([$_POST['type'], $_POST['note'], $_POST['time']]);
                    ...
                    <div class="card-body">
                        ...
                        <form action="" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input name="time" type="text" class="form-control" placeholder="0000-00-00 00:00:00">
                            </div>
                            <button class="btn btn-success">Sukurti įrašą</button>
